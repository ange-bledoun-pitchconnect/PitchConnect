...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // ============================================================================
        // PITCHCONNECT BRAND COLORS (From Screenshot + Psychology Research)
        // ============================================================================
        
        // GOLD PALETTE - Primary CTA, Premium Features, Achievement
        // Psychology: Trust, Excellence, Leadership, Premium Quality
        gold: {
          50: '#FFFCF5',
          100: '#FFF9EB',
          200: '#FEF0C7',
        ...
        // ORANGE PALETTE - Energy, Action, Enthusiasm
        // Psychology: Excitement, Motivation, Athletic Energy
        orange: {
          50: '#FFF7ED',
          100: '#FFEDD5',
          200: '#FED7AA',
          300: '#FDBA74',
          400: '#FF6B35', // PRIMARY BRAND ORANGE
          500: '#F97316',
          600: '#EA580C',
          700: '#C2410C',
          800: '#9A3412',
        ...
        // PURPLE PALETTE - Innovation, Creativity, Collaboration
        // Psychology: Sophistication, Team Spirit, Future-Forward
        purple: {
          50: '#FAF5FF',
          100: '#F3E8FF',
          200: '#E9D5FF',
        ...
        // CHARCOAL/BLACK PALETTE - Professional, Depth, Text
        // Psychology: Authority, Professionalism, High Contrast
        charcoal: {
          50: '#F9FAFB',
          100: '#F3F4F6',
          200: '#E5E7EB',
        ...
        // NEUTRAL/WHITE PALETTE - Clean, Modern, Professional
        // Psychology: Clarity, Simplicity, Trust
        neutral: {
      ...
      backgroundImage: {
        ...
        // Mesh Gradients (Modern SaaS Style)
