...
export default function SuperAdminLayout({ children }: SuperAdminLayoutProps) {
  ...
  useEffect(() => {
    ...
    // Redirect non-SuperAdmin users away
  ...
  // ============================================================================
  const navItems = [
    // ⚠️ FIXED: Points to /dashboard/superadmin instead of /overview
  ...
  // ============================================================================
  // RENDER: SuperAdmin Layout with Sidebar + Main Content
  // ============================================================================
  return (
    <div className="flex h-screen bg-neutral-50 dark:bg-charcoal-900 transition-colors duration-200">
      ...
      >
        ...
        <nav className="p-4 space-y-2 overflow-y-auto flex-1">
          {navItems.map((item) => {
            // Active check - handle both exact and prefix matches
            // Special case for Overview to avoid highlighting on every sub-page
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Top Header - Mobile toggle + breadcrumb */}
        <header className="md:hidden bg-white dark:bg-charcoal-800 border-b border-neutral-200 dark:border-charcoal-700 px-4 py-4 flex items-center justify-between">
          <button
